...
@Entity
@Table(name = "detail_hasil_hamparan")
public class DetailHasil implements Serializable {
   ...
   * @param status
   */
  public DetailHasil(String kd_hasil, String kd_anggota, String kd_kebun, String kd_mobil, char status) {
